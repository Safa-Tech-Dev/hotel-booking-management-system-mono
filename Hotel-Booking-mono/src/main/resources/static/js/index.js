function validation() {
	...
	if ((city.length <= 2) || (city.length > 30)) {
		document.getElementById('cityName').innerHTML = " ** City length must be between 2 to 30";
		return false;
	}
	if (checkin == "") {
...
function guestValidation() {
	...
	if ((GuestFirstName.length < 2) || (GuestFirstName.length > 15)) {
		document.getElementById('FirstName').innerHTML = " ** First Name length must be between 2 to 15";
		return false;
	}
	...
	if (hotelID == "") {
		document.getElementById('Hotel ID').innerHTML = " ** Please fill the Hotel Id";
		return false;
	}
	...
	if (Tguest <= 0) {
		document.getElementById('Total Guest').innerHTML = " ** Please fill  atleast 1 guest ";
		return false;
	}
	if (isNaN(Tguest)) {
		document.getElementById('Total Guest').innerHTML = " ** user must write digits only not characters";
		return false;
	...
	if (Totalrooms <=0 ) {
		document.getElementById('Total Rooms').innerHTML = " ** Please fill  atleast 1 room";
		return false;
	}
	if (isNaN(Totalrooms)) {
...
function validation3(){
	...
	if(hotelid == ""){
		document.getElementById('Hotel Id').innerHTML =" ** Please fill the Hotel ID field";
		return false;
	}
...
function check(elem) {
    ...
    if (elem.value == 'Aadhaar Card') {
        ...
        document.getElementById("uid-aadhaar").style.display = 'none';
    } else {
        document.getElementById("uid-aadhaar").style.display = 'none';
        document.getElementById("uid-panCard").style.display = 'none';
    }
...
function registerValidation4() {
	...
	/*if(!validateState()){
		document.getElementById('States').innerHTML = " ** Please Select State";
		return false;
	}*/
	if (uanAdhar == "") {
...
function hotelValidation(){
	...
	var hName = document.getElementById('hotelname').value;
	var hId = document.getElementById('hotelId').value;
	var City = document.getElementById('city').value;
	var availableRooms = document.getElementById('rooms').value;
	var Price = document.getElementById('price').value;
	...
	if((hName.length <= 2) || (hName.length > 40)) {
		document.getElementById('Hotel Name').innerHTML =" ** Hotel Name length must be between 2 and 20";
		return false;	
	}
	if(!isNaN(hName)){
	...
	if (availableRooms == "") {
		document.getElementById('ROOM').innerHTML = " ** Please fill the Room field";
		return false;
	}
...
function validateRooms(){
		...
		var availableRoom = document.getElementById('avlRooms').value;
		var enteredRoom = document.getElementById('totalroom').value;
		
		if (enteredRoom>availableRoom){
			
			alert('you can not enter value more than available rooms');
			//return true;
		}
		else{
			
			alert('false');
			document.getElementById('totalroom').value =enteredRoom;
		}
...
function calculateBill(){
	...
	var availableRoom = document.getElementById('avlRooms').innerText;
	

	if (totalRoom != 0){
		if ( parseInt(totalRoom) > parseInt(availableRoom)){
			
			alert('you can not enter value more than available rooms');
			document.getElementById('totalroom').value = 0;
	
		}
		else{
	
		var prices = document.getElementById('price').innerText;
		var totalBill = totalRoom * prices;
		document.getElementById('amount').value = totalBill;
	}
